...
// Backend imports commented for local mode
...
public class RegisterController extends BaseController implements Initializable {
    ...
    private void handleRegister() {
        // LOCAL MODE: Skip registration and go directly to dashboard
        ViewNavigator.navigateToDashboard();

        // Original backend-dependent code (commented for local mode)
        /*
        clearErrors();
        ...
        runAsync(
            () -> { authService.register(username, email, password); return null; },
            ignored -> {
